...
<html class="no-js" lang="pt-br">
  <head>
    ...
    <title>Aluno - Agenda Universitária</title>
  ...
  <body>
      ...
      <div class="grid-all box">
        ...
        <div class="row margin-bottom text-left">
        	<a class="btn btn-success" href="aluno/cadastrar">Inserir novo registro</a>
        </div>
          ...
          <table>
          	<thead>
          		<tr>
          			<th>Nome</th>
          			<th>E-mail</th>
          			<th class="mobile-hidden">Data de Cadastro</th>
          			<th>Ações</th>
          		</tr>
          	</thead>
          	...
          	<tbody>
          		<tr>
          			...
          			<td class="mobile-hidden">00/00/0000</td>
